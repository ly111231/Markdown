...
if(CROSS_COMPILE)
    ...
    set(OpenCV_DIR "/usr/local/opencv_aarch64/share/OpenCV" CACHE PATH "Path to OpenCV")
    set(CMAKE_PREFIX_PATH "/usr/local/aarch64/eigen3_aarch64" ${CMAKE_PREFIX_PATH})
    SET(g2o_LIBRARY_OUTPUT_DIRECTORY ${g2o_SOURCE_DIR}/lib_arm64 CACHE PATH "Target for the libraries")
else()
    message(STATUS "CROSS_COMPILE is OFF. Using native host compiler.")
    message(STATUS "222222222222")
...
make -j$(nproc) # 在lib_arm64目录生成libg2o.so共享库
```
